...
const SpinnerButton: React.FC<SpinnerButtonProps> = ({
 ...
 const [isFlashing, setIsFlashing] = useState(false); // State to control button flash
 ...
 setFinalSnap(false);
 setIsFlashing(false);
 setConfettiActive(false); // Ensure confetti is off when spinning starts
 ...
 // Start flashing and confetti
 setIsFlashing(true);
 setConfettiActive(true);
 flashTimeout.current = setTimeout(() => {
 setIsFlashing(false);
 // Keep confetti active for a bit longer
 confettiTimeout.current = setTimeout(() => {
 setConfettiActive(false);
 }, 1500); // Keep confetti for 1.5 seconds after flash
